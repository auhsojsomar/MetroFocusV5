...
<body>
    <div class="main-wrapper">
                                ...
                                <div class="card-block">
                                    <section class="example">
                                        <div class="table-responsive">
                                            <table id="accessoriestable" class="table table-bordered table-striped table-hover nowrap"
                                                style="width:100%">
                                                <thead>
                                                    <tr>
                                        ...
                                        <button class="button is-danger" id="deleteselected" style="margin-top:10px">Delete
                                            Selected</button>
                                    </section>
                                </div>
                            </div>
                ...
                <section class="modal-card-body">
                    <form method="POST" name="vform" id="vform" onsubmit="return Validate();" enctype="multipart/form-data">
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-right">
                                <textarea maxlength="200" name="description" id="description" class="textarea"
        ...
        <div class="modal" id="defectmodal">
            ...
            <div class="modal-card">
                <header class="modal-card-head">
                    <h1 class="modal-card-title" id="modaltitledr">Defect</h1>
                </header>
                <section class="modal-card-body">
            ...
            function Validate() {
                ...
                if ($('#user_image').val() == "" && $('#operation').val() == "Add") {
                    ...
                    return false;
                        ...
                        "") && (productquantity.value != 0) && (productprice.value != 0)) {

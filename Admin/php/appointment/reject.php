<?php
    ...
    $sql = mysqli_query($con,"SELECT firstname,loginform.cnumber,schedule FROM loginform,appointment WHERE appointment.username = loginform.username AND appointment.id = $id AND appointment.status != 'Reject' AND appointment.status != 'Done'");

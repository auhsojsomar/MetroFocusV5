                                    ...
                                    <div class="card-block">
                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table id="faqtable" class="table table-bordered table-striped table-hover nowrap"
                                                    style="width:100%">
                                                    <thead>
                                                        <tr>
			...
			<div class="modal-card">
				<form id="reasonform" onsubmit="return Reason()">
					...
					<footer class="modal-card-foot">
						...
						<input type="hidden" name="reasontype" id="reasontype" value="FAQ">
					</footer>
				</form>
			</div>
		</div>
    ...
    <script>
        ...
        $(document).on('click','button[name="restore"]',function(){
            ...
            $.ajax({
                ...
                method:'POST',
                data:{id : id,type : 'FAQ',restoreaction : 'Restore'},
        ...
        $('#restoreselected').click(function () {
            ...
            if (id.length === 0) {
                ...
                url:'php/trash/restore.php',
                method:'POST',
                data:{id : id,type : 'FAQ',restoreaction : 'RestoreAll'},
                success:function(data){
                    swal('Data Recovered','','success',{
                        closeOnClickOutside:false
                    })

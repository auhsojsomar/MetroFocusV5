                                    ...
                                    <div class="card-block">
                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table id="categorytable" class="table table-bordered table-striped table-hover nowrap"
                                                    style="width:100%">
                                                    <thead>
                                                        <tr>
			...
			<div class="modal-card">
				<form id="reasonform" onsubmit="return Reason()">
					...
					<footer class="modal-card-foot">
						...
						<input type="hidden" name="reasontype" id="reasontype" value="Category">
					</footer>
				</form>
			</div>
		</div>
    ...
    <script>
        ...
        $(document).on('click','button[name="restore"]',function(){
            ...
            $.ajax({
                ...
                method:'POST',
                data:{id : id,type : 'Category',restoreaction : 'Restore'},
        ...
        $('#restoreselected').click(function () {
            ...
            if (id.length === 0) {
                ...
                url:'php/trash/restore.php',
                method:'POST',
                data:{id : id,type : 'Category',restoreaction : 'RestoreAll'},
                success:function(data){
                    swal('Data Recovered','','success',{
                        closeOnClickOutside:false
                    })

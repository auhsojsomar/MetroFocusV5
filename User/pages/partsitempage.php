					...
					<form id="vform2" method="POST" class="control">
						<div class="column">
							...
							<div class="item-description">
								<p class="has-text-black-bis" id="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae
									quod error, quasi incidunt officia voluptatem odit aperiam eveniet ab voluptatibus, dolores facilis! Sunt
									facilis sed soluta accusantium veniam aliquid rem. </p>
								<br>
							</div>
							<div class="field">
								<br>
								...
								$sql2 = mysqli_query($con,"SELECT * FROM cart WHERE user='$user' AND type = 'Parts' AND item_id = $id");
								...
								<style>
									...
									<input readonly id="quantity" name="quantity" type="number" min="1" max="<?php echo $row['quantity']-$row2['quantity'] ?>"
									 value="1" style="width: 4ch;">
								</div>
								<p class="control">

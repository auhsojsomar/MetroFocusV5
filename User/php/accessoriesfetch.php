<?php
	...
	$sql = mysqli_query($con,"SELECT * FROM accessories WHERE status = 'Active' AND deleted = 0 ORDER BY id DESC");
	$output = '';
                        ...
                        <div class="card" style="min-width: 232px;min-height: 236px;margin-top:20px;">
                            <div class="card-image">
                                <figure class="image is-4by3">
                                    <img src="../../Admin/php/accessories/upload/'.$row['image'].'">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        ...
                                        <a class="button button is-warning" href="accessoriesitempage.php?item='.$row['id'].'">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>	
